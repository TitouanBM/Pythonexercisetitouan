...
# TODO: Write your code below
print('first charactere of', txt[0])


# 2.1.3 Get the characters from index 1 to index 3 (err).
# TODO: Write your code below
print('characters from index 1 to index 3', txt[1:4])
...
x = " Hello World "
# TODO: Write your code below
print('remove white space', x.strip())
...
y = "Hello"
# TODO: Write your code below
print('replaced first character :', y.replace("H","J"))
